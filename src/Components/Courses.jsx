...
function Courses() {
  ...
  if(authToken) {
    const enrollRequest = { userId: userId, courseId: courseId };
...
<div>
  ...
  <button className="enroll-button" onClick={() => { enrollCourse(course.course_id); navigate(`/course/${course.course_id}`); }}>
    Enroll
  </button>
)}
